---
title: Manifesto
description: The principles and philosophy behind Oh My OpenAgent
---
...
Code written by the agent should be indistinguishable from code written by a senior engineer.
</Card>
...
<CardGroup cols={2}>
  <Card title="Prometheus (Interview Mode)" icon="comments">
  ...
  <Card title="Ultrawork (Just Do It Mode)" icon="bolt">
...
<Steps>
  <Step title="Describe what you want">
    High-level or detailed, your choice
  </Step>
  <Step title="Let the agent interview you">
    If needed for clarification
  </Step>
  <Step title="Confirm the plan">
    Or just let ultrawork handle it
  </Step>
  <Step title="Walk away">
    Let the agent work
  </Step>
  <Step title="Come back to completed work">
